<template>
  <div class="layout-px-spacing mt-3">
      ...
      <div class="text-center"><h4>BUSHMAN SAFARI TRACKERS LIMITED</h4></div>
  <!-- tab starts -->
                           ...
                           <tr>
                               <td :class="approval_status_data.operation_department === 0 ? 'text-danger' : 'text-success'">
                                  ...
                                  <td :class="approval_status_data.project_manager === 0 ? 'text-danger' : 'text-success'">
                                                                   ...
                                                                   <button v-if="approval_status_data.project_manager === 0 && is_project_manager" @click="approveCheck(approval_status_data.id, 'project_manager'),spinner=!spinner" :class="{ disabled: spinner }" class="btn btn-primary p-1 btn-sm me-2">
                                                                       <div v-if="spinner" class="spinner-border text-white" role="status">
                                                                         <span class="sr-only"></span>
                                                                        </div>
                                                                        <div v-else>Check</div>
                                                                   </button>
                                                                   <button v-if="approval_status_data.project_manager === 1 && is_project_manager" @click="approveUnCheck(approval_status_data.id, 'project_manager'),spinner=!spinner" :class="{ disabled: spinner }" class="btn btn-danger p-1 btn-sm me-2">
                                                                       <div v-if="spinner" class="spinner-border text-white" role="status">
                                                                         <span class="sr-only"></span>
                                                                        </div>
                                                                        <div v-else>Uncheck</div>
