<template>
    <div class="layout-px-spacing">  
            ...
            <div class="d-flex me-4 mt-2 ">
                        <div class="ms-auto">
                            <button class="btn btn-primary disabled" data-bs-toggle="modal" data-bs-target="#exampleModal">                           <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-plus-square" viewBox="0 0 16 16">
...
<script setup>
    ...
    const axiosInstance = axios.create({
      baseURL: "https://ghrm.abooderp.com/api/employees/",
    });
    ...
    const columns = ref(['id', 'full_name','date_of_birth','gender','marital_status', 'actions']);
    const items = ref([]);
    ...
    const getEmployees = () => {
        ...
        axiosInstance.get('/information?entity_id=6').then((response) => {
