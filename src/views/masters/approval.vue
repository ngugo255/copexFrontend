<template>
                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Approval Group</span></li>
                            </ol>
                        </nav>
                    </div>
                </li>
 ...
 <form v-if="role_registration" class="mt-3 p-3 border rounded bg-white shadow" @submit.prevent="registerRole">
        <h4 class="text-center">APPROVAL GROUP  REGISTRATION FORM</h4>
        <div class="row mb-2">
    
            <div class="col-md-12">
                <label class="form-label">Approval Group Name</label>
                <input type="text" class="form-control" placeholder="Enter Approval Group Name" v-model="name" required>
            </div>
...
<script setup>
    ...
    const getRoles = () => {
        ...
        axiosInstance.get('/approval-groups')
            .then((response) => {
